...
export default function ProductPage() {
  const product =     {
    ...
    femaleCharacteristics: [
      ...
      { label: "Бриллиант", value: "86шт/1,12 кр" },
    ],
    maleCharacteristics: [
      { label: "Изумруд", value: "2,38 кр" },
      { label: "Вес", value: "6,31 г" },
    ],
    additionalInfo: "Центральный изумруд — 2,38 карата, каплевидной огранки, из Колумбии — региона, где рождаются самые ценные и чистые зелёные камни.\n Изумруд символизирует интуицию, любовь, внутреннюю гармонию, подходит Ракам, Тельцам, Весам и Близнецам. Его носили Клеопатра, Элизабет Тейлор и Анджелина Джоли.\n Вокруг — 86 канадских бриллиантов, общим весом 1,12 карата.\n Чистота — 4/4А, огранка — 57 граней, блеск — как у камней Tiffany & Co.",
  }
