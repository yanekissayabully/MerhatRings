...
export default function ProductPage() {
  const product =     {
    ...
    femaleCharacteristics: [
      ...
      { label: "Бриллиант", value: "11шт/0,45 кр" },
    ],
    maleCharacteristics: [
      { label: "Вес", value: "1,61 г" },
    ],
    additionalInfo: "Камни: 11 канадских бриллиантов, общим весом 0,45 карата\nЧистота: 4/4А\nОгранка: классическая, 57 граней\nБриллианты канадского происхождения с безупречной репутацией и этической сертификацией, как у Tiffany & Co.",
  }
